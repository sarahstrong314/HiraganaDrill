...
var dict19 = {'おふろに はいります':'to take a bath', 'てがみを だします':'to send a letter', 'にもつを おくります':'to send a package', 'おかねを だします':'to withdraw some money', 'けんぶつします':'to go sight seeing', 'かいものに いきます':'to shop', 'しつれんします':'to be brokenhearted', 'スポーツを します':'to play sports', 'そうじを します':'to clean'};
