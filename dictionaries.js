...
var dict9 = {'すき':'like', 'きらい':'dislike', 'とても':'very', 'じょうず':'skillful', 'へた':'not skillful', 'わかります':'to understand', 'ねつ':'fever', 'かぜ':'cold (disease)', 'おなか':'stomach', 'やくそく':'promse or appointment', 'ようじ':'something to do', 'じゅぎょう':'class'};
...
var dict15 = {'おきます':'to put or to wake up', 'けします':'to turn off', 'しります':'to know', 'つくります':'to make', 'うります':'to sell', 'もちます':'to have', 'あけます':'to open', 'しめます':'to close', 'つけます':'to turn on', 'けっこんします':'to get married', 'きんえん':'non-smoking', 'すみます':'to live', 'きょうだい':'sibling'};
