...
var dict18 = {'うたいます':'to sing', 'かいます':'to buy', 'さわります':'to touch', 'きります':'to cut', 'おくります':'to send', 'あるきます':'to walk', 'ねます':'to sleep or to go to bed', 'とめます':'to stop or to park', 'うんてんします':'to drive', 'します':'to do'};
...
var arr17 = [['おします', 'push', 'おさない', 'not push'], ['おきます', 'put', 'おかない', 'not put'],  ['いきます', 'go', 'いかない', 'not go'], ['はらいます', 'pay', 'はらわない', 'not pay'], ['もっていきます', 'bring', 'もっていかない', 'not bring'], ['つかいます', 'use', 'つかわない', 'not use'], ['なくします', 'lose (something)', 'なくさない', 'not lose (something)'], ['かえります', 'return or go home', 'かえらない', 'not go home'], ['くすりを のみます', 'take medicine', 'くすりを のまない', 'not take medicine'], ['かえします', 'return (something)', 'かえさない', 'not return (something)'], ['だします', 'hand in', 'ださない', 'not hand in'], ['いれます', 'put in', 'いれない', 'not put in'], ['わすれます', 'forget', 'わすれない', 'not forget'], ['くるまを とめます', 'park a car', 'くるまを とめない', 'not park a car'], ['おぼえます', 'remember', 'おぼえない', 'not remember'],['でかけます', 'go out', 'でかけない', 'not go out'], ['アルバイトを します', 'do a part-time job', 'アルバイトを しない', 'not do a part-time job'], ['しんぱいします', 'worry', 'しんぱいしない', 'not worry'], ['きます', 'come', 'こない', 'not come'], ['しゅっちょうします', 'go on a business trip', 'しゅっちょうしない', 'not go on a business trip’], [‘つくります', 'make', 'つくらない', 'not make'], ['ぬぎます', 'take off', 'ぬがない', 'not take off'], ['あいます', 'meet', 'あわない', 'not meet'], ['とります', 'take', 'とらない', 'not take'], ['かきます', 'write', 'かかない', 'not write'], ['はいります', 'enter', 'はいらない', 'not enter'], ['よびます', 'call', 'よばない', 'not call'], ['つけます', 'turn on', 'つけない', 'not turn on'], ['はなします', 'speak', 'はなさない', 'not speak'], ['みせます', 'show', 'みせない', 'not show'], ['たべます', 'eat', 'たべない', 'not eat'], ['いれます', 'put in', 'いれない', 'not put in'], ['おきます', 'wake up', 'おきない', 'not wake up']];
var arr18 = [['うたいます', 'sing', 'うたう', 'to sing'], ['かいます', 'buy', 'かう', 'to buy'], ['さわります', 'touch', 'さわる', 'to touch'], ['きります', 'cut', 'きる', 'to cut'], ['おくります', 'send', 'おくる', 'to send'], ['あるきます', 'walk', 'あるく', 'to walk'],  ['ねます', 'sleep or go to bed', 'ねる', 'to sleep or to go to bed'], ['とめます', 'stop or to park', 'とめる', 'to stop or to park'], ['うんてんします', 'drive', 'うんてんする', 'to drive'], ['します', 'do', 'する', 'to do'], ['はらいます', 'pay', 'はらう', 'to pay'], ['つくります', 'make', 'つくる', 'to make'], ['のります', 'ride', 'のる', 'to ride'], ['かえります', 'return or go home', 'かえる', 'to return or go home'], ['とります', 'take', 'とる', 'to take'], ['しります', 'know', 'しる', 'to know'], ['あそびます', 'play or to hang out', 'あそぶ', 'to play or to hang out'], ['ひきます', 'play (string instruments or piano)', 'ひく', 'to play string instruments or piano'], ['はを みがきます', 'brush one\', s teeth', 'はを みがく', 'to brush one\'s teeth'], ['おしえます', 'teach', 'おしえる', 'to teach'],['たべます', 'eat', 'たべる', 'to eat'], ['みます', 'see', 'みる', 'to see'], ['かります', 'borrow', 'かりる', 'to borrow'], ['きます', 'come', 'くる', 'to come'], ['あります', 'have or to exist (a thing)', 'ある', 'to have or to exist (things)'], ['います', 'have or exist (living creature)', 'いる', 'to have or to exist (living creature)']];
