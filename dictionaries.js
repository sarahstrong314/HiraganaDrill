...
var dict12 = {'いい てんき':'good weather', 'あめ':'rain', 'くもり':'cloudy day', 'ゆき':'snow', 'ゆうめいじん':'celebrity', 'きせつ':'season', 'たべもの':'food', 'のみもの':'drink', 'どうぶつ':'animal', 'いちばん':'no. 1', 'すずしい':'cool (temperature)','からだに いい':'healthy','うるさい':'noisy','びんぼう (な)':'poor', 'いじわる':'mean', 'せが たかい':'tall (a person)', 'せが ひくい':'short (a person)', 'です':'to be'};
...
var arr12 = [[['あついです', 'it is hot'], ['あつくないです', 'it is not hot'], ['あつかったです', 'it was hot'], ['あつくなかったです', 'it was not hot']], [['さむいです', 'it is cold (weather)'], ['さむくないです', 'it is not cold (weather)'], ['さむかったです', 'it was cold (weather)'], ['さむくなかったです', 'it was not cold (weather)']], [['あたたかいです', 'it is warm'], ['あたたかくないです', 'it is not warm'], ['あたたかかったです', 'it was warm'], ['あたたかくなかったです', 'it was not warm']], [['すずしいです', 'it is cool (temperature)'], ['すずしくないです', 'it is not cool (temperature)'], ['すずしかったです', 'it was cool (temperature)'], ['すずしくなかったです', 'it was not cool (temperature)']], [['おいしいです', 'it is delicious'], ['おいしくないです', 'it is not delicious'], ['おいしかったです', 'it was delicious'], ['おいしくなかったです', 'it was not delicious']], [['からだに いいです', 'it is healthy'], ['からだに よくないです', 'it is not healthy'], ['からだに よかったです', 'it was healthy'], ['からだに よくなかったです', 'it was not healthy']], [['たかいです', 'it is expensive or high'], ['たかくないです', 'it is not expensive or high'], ['たかかったです', 'it was expensive or high'], ['たかくなかったです', 'it was not expensive or high']], [['げんきです', 'it is cheerful'], ['げんきじゃありません', 'it is not cheerful'], ['げんきでした', 'it was cheerful'], ['げんきじゃありませんでした', 'it was not cheerful']], [['しずかです', 'it is quiet'], ['しずかじゃありません', 'it is not quiet'], ['しずかでした', 'it was quiet'], ['しずかじゃありませんでした', 'it was not quiet']], [['きれいです', 'it is beautiful or clean'], ['きれいじゃありません', 'it is not beautiful or clean'], ['きれいでした', 'it was beautiful or clean'], ['きれいじゃありませんでした', 'it was not beautiful or clean']], [['あたまが いいです', 'it is smart'], ['あたまが よくないです', 'it is not smart'], ['あたまが よかったです', 'it was smart'], ['あたまが よくなかったです', 'it was not smart']], [['いじわるです', 'it is mean'], ['いじわるじゃありません', 'it is not mean'], ['いじわるでした', 'it was mean'], ['いじわるじゃありませんでした', 'it was not mean']], [['せが たかいです', 'he is tall'], ['せが たかくないです', 'he is not tall'], ['せが たかかったです', 'he was tall'], ['せが たかくなかったです', 'he was not tall']], [['せが ひくいです', 'he is short'], ['せが ひくくないです', 'he is not short'], ['せが ひくかったです', 'he was short'], ['せが ひくくなかったです', 'he was not short']], [['しんせつです', 'it is kind'], ['しんせつじゃありません', 'it is not kind'], ['しんせつでした', 'it was kind'], ['しんせつじゃありませんでした', 'it was not kind']], [['かっこいいです', 'it is cool or stylish'], ['かっこよくないです', 'it is not cool or stylish'], ['かっこよかったです', 'it was cool or stylish'], ['かっこよくなかったです', 'it was not cool or stylish']], [['うるさいです', 'it is noisy'], ['うるさくないです', 'it is not noisy'], ['うるさかったです', 'it was noisy'], ['うるさくなかったです', 'it was not noisy']], [['びんぼうです', 'it is poor'], ['びんぼうじゃありません', 'it is not poor'], ['びんぼうでした', 'it was poor'], ['びんぼうじゃありませんでした', 'it was not poor']], [['おもしろいです', 'it is interesting'], ['おもしろくないです', 'it is not interesting'], ['おもしろかったです', 'it was interesting'], ['おもしろくなかったです', 'it was not interesting']], [['たのしいです', 'it is fun'], ['たのしくないです', 'it is not fun'], ['たのしかったです', 'it was fun'], ['たのしくなかったです', 'it was not fun']]];

var dict14_te = {'てつだいます (help)':['てつだって', 'help'], 'いいます (say)':['いって', 'say'], 'たちます (stand)':['たって', 'stand'], 'まちます (wait)':['まって', 'wait'], 'すわります (sit)':['すわって', 'sit'], 'はいります (enter)':['はいって', 'enter'], 'とります (take)':['とって', 'take'], 'よびます (call)':['よんで', 'call'], 'しにます (die)':['しんで', 'die'], 'ひきます (play (string instruments or piano))':['ひいて', 'play (string instruments or piano)'], 'いそぎます (hurry)':['いそいで', 'hurry'], 'ぬぎます (take off)':['ぬいで', 'take off'], 'みせます (show)':['みせて', 'show'], 'さんぽを します (go for a walk)':['さんぽを して', 'go for a walk'], 'あめが ふります (rain)':['あめが ふって', 'rain'], 'ふくを きます (wear clothes)':['ふくを きて', 'wear clothes'], 'ぼうしを かぶります (wear a hat)':['ぼうしを かぶって', 'wear a hat']};  
var dict17_nai = {'おきます (put)':['おかない', 'not put'], 'つくります (make)':['つくらない', 'not make'], 'おします (push)':['おさない', 'not push'], 'ぬぎます (take off)':['ぬがない', 'not take off'], 'いきます (go)':['いかない', 'not go'], 'はらいます (pay)':['はらわない', 'not pay'], 'もっていきます (bring)':['もっていかない', 'not bring'], 'あいます (meet)':['あわない', 'not meet'], 'つかいます (use)':['つかわない', 'not use'], 'とります (take)':['とらない', 'not take'], 'なくします (lose (something))':['なくさない', 'not lose (something)'], 'かえります (return or go home)':['かえらない', 'not go home'], 'くすりを のみます (take medicine)':['くすりを のまない', 'not take medicine'], 'かきます (write)':['かかない', 'not write'], 'かえします (return (something))':['かえさない', 'not return (something)'], 'はいります (enter)':['はいらない', 'not enter'], 'よびます (call)':['よばない', 'not call'], 'つけます (turn on)':['つけない', 'not turn on'], 'はなします (speak)':['はなさない', 'not speak'], 'だします (hand in)':['ださない', 'not hand in'], 'いれます (put in)':['いれない', 'not put in'], 'わすれます (forget)':['わすれない', 'not forget'], 'くるまを とめます (park a car)':['くるまを とめない', 'not park a car'], 'みせます (show)':['みせない', 'not show'], 'おきます (wake up)':['おきない', 'not wake up'], 'おぼえます (remember)':['おぼえない', 'not remember'], 'たべます (eat)':['たべない', 'not eat'], 'でかけます (go out)':['でかけない', 'not go out'], 'アルバイトを します (do a part-time job)':['アルバイトを しない', 'not do a part-time job'], 'しんぱいします (worry)':['しんぱいしない', 'not worry'], 'きます (come)':['こない', 'not come'], 'しゅっちょうします (go on a business trip)':['しゅっちょうしない', 'not go on a business trip']};
var dict18_dict = {'うたいます (sing)':['うたう', 'to sing'], 'はらいます (pay)':['はらう', 'to pay'], 'かいます (buy)':['かう', 'to buy'], 'つくります (make)':['つくる', 'to make'], 'さわります (touch)':['さわる', 'to touch'], 'きります (cut)':['きる', 'to cut'], 'のります (ride)':['のる', 'to ride'], 'かえります (return or go home)':['かえる', 'to return or go home'], 'おくります (put)':['おくる', 'to put'], 'とります (take)':['とる', 'to take'], 'しります (know)':['しる', 'to know'], 'あそびます (play or to hang out)':['あそぶ', 'to play or to hang out'], 'ひきます (play (string instruments or piano))':['ひく', 'to play string instruments or piano'], 'あるきます (walk)':['あるく', 'to walk'], 'はを みがきます (brush one\'s teeth)':['はを みがく', 'to brush one\'s teeth'], 'おしえます (teach)':['おしえる', 'to teach'], 'ねます (sleep or go to bed)':['ねる', 'to sleep or to go to bed'], 'とめます (stop or to park)':['とめる', 'to stop or to park'], 'たべます (eat)':['たべる', 'to eat'], 'みます (see)':['みる', 'to see'], 'かります (borrow)':['かりる', 'to borrow'], 'うんてんします (drive)':['うんてんする', 'to drive'], 'きます (come)':['くる', 'to come'], 'します (do)':['する', 'to do'], 'あります (have or to exist (a thing))':['ある', 'to have or to exist (things)'], 'います (have or exist (living creature))':['いる', 'to have or to exist (living creature)']};
var dict19_ta = {'のります (ride)':['のった', 'rode'], 'のみます (drink)':['のんだ', 'drank'], 'よみます (read)':['よんだ', 'read'], 'いきます (go)':['いった', 'went'], 'あそびます (play or hang out)':['あそんだ', 'played or hung out'], 'あいます (meet)':['あった', 'met'], 'おふろに はいります (take a bath)':['おふろに はいった', 'took a bath'], 'てがみを だします (send a letter)':['てがみを だした', 'sent a letter'], 'にもつを おくります (send a package)':['にもつを おくった', 'sent a package'], 'およぎます (swim)':['およいだ', 'swam'], 'ならいます (learn)':['ならった', 'learned'], 'おかねを だします (withdraw some money)':['おかねを だした', 'withdrew some money'], 'けんぶつします (go sightseeing)':['けんぶつした', 'went sightseeing'], 'かきます (write)':['かいた', 'wrote'], 'うたいます (sing)':['うたった', 'sang'], 'かいものに いきます (shop)':['かいものに いきました', 'shopped'], 'たべます (eat)':['たべた', 'ate'], 'みます (see)':['みた', 'saw'], 'ねます (sleep or go to bed)':['ねた', 'slept or went to bed'], 'おります (get off)':['おりた', 'got off'], 'かります (borrow )':['かりた', 'borrowed'], 'しつれんします (be brokenhearted)':['しつれんした', 'was brokenhearted'], 'スポーツを します (play sports)':['スポーツを した', 'played sports'], 'あらいます (wash)':['あらった', 'washed'], 'そうじを します (clean)':['そうじを した', 'cleaned']};
