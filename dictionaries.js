...
var dict20 = {'できる':'to be able or to be ready', 'いい':'good'}; // need one more entry
var dict21 = {'かつ':'to win', 'やくにたつ':'to be useful', 'ユーモアがある':'to be humourous', 'むだ':'useless', 'たりない':'insufficient', 'たいへん':'difficult'};
var dict22 = {'かいものをする':'to go shopping', 'とまる':'to stay overnight'}; // need one more entry
var dict23 = {'わたる':'to go across', 'ちず':'map', 'しんごう':'traffic light', 'はし':'bridge or chopsticks', 'くつや':'shoe store', 'かど':'corner', 'さいしょ (の)':'the first', 'むかい':'facing', 'つきあたり':'end (of a street, etc.)', 'しやくしょ':'city hall'};
...
var dict27 = {'ふたつ いじょう':'more than two', '100メートル':'100 meters', 'せんしゅ':'player', 'ひとつめ':'first of all', 'ふたつめ':'second of all', 'かど':'corner', 'しんごう':'traffic light', 'いっけんめ':'first building', 'ちょきん':'bank deposit', 'のぼる':'to climb', 'でんわを かける':'to make a phone call'};
